package com.fngeno.messagingservice.controller;

import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.fngeno.messagingservice.pojos.Book;
import com.fngeno.messagingservice.pojos.BookOrder;
import com.fngeno.messagingservice.pojos.Customer;
import com.fngeno.messagingservice.services.BookOrderService;
...
public class AppController {
    ...
    List<Book> books = Arrays.asList(
                                     new Book("jpw-1234", "Frank Kim", "Lord of the Flies"),
                                     new Book("uyh-2345","Fabians Kips", "Being and Nothingness"),
                                     new Book("iuhj-87654", "Cathy Ches","At Sea and Lost"));
